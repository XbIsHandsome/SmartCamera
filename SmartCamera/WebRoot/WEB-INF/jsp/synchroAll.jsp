...
<div >&nbsp;</div>
	<div style="margin-top: 70px" wraper container-fluid">
		...
		<div class="row text-center">
			<s:if test="#session.SynchroList != null">
				<s:iterator value="#session.SynchroList" var="class">
					<a href="${pageContext.request.contextPath}/synchro_showDetail.action">
						<div class="col-sm-6 col-md-3">
							<div class="panel">
								<div class="h3 text-top-blue">
									<s:property value="#class.grade"/>/<s:property value="#class.class_name"/>
								</div>
								<span class="text-success">
									<s:property value="#class.actualNum"/>
									/
									<s:property value="#class.number"/>
								</span>
